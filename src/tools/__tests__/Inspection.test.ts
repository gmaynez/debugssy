...
describe("InspectionTools", () => {
  ...
  describe("getVariables", () => {
    ...
    it("should handle errors gracefully", async () => {
      vscode.debug.activeDebugSession = mockSession;
      vi.spyOn(dapClient, "getStackTrace").mockRejectedValue(
  ...
  describe("evaluateExpression", () => {
    ...
    it("should evaluate expression in specific frame", async () => {
      ...
      expect(dapClient.evaluateExpression).toHaveBeenCalledWith(
        mockSession,
        "str",
        5,
      );
    ...
    it("should handle evaluation errors", async () => {
      vscode.debug.activeDebugSession = mockSession;
      vi.spyOn(dapClient, "evaluateExpression").mockRejectedValue(
